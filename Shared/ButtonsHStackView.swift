...
struct ButtonsHStackView: View {
    ...
    var body: some View {
        ...
        HStack {
            ...
            .frame(width: 80, height: 80)
            .background(selectedTab != (MockData.onboardingPages.endIndex - 1) ? Color.purple.clipShape(Circle()) : Color.gray.clipShape(Circle()))
            .foregroundColor(.white)
            .disabled(selectedTab == (MockData.onboardingPages.endIndex - 1))
        }
    }
}
